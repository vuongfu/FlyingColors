...
INSERT INTO [Tutor] (RoleId,LastName,FirstName,BirthDate,Gender,[Address],Email,SkypeId,UserName,[Password],City,PostalCode,Country,PhoneNumber,Balance,BankId,Salary,Photo,[Description],BankName,BMemName,isActived) VALUES (7,N'Nguyễn Văn',N'Sư',1986-4-25,1,N'số 8 Trần Duy Hưng','sunv@gmail.com','sunv','sunv','sunv',N'Hà Nội',null,N'Vietnam','01632231938',0,'9716543210',150000,null,null,N'ngân hàng Tiên Phong','tutor6',1);
